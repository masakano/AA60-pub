...
public:
	...
	void init(const Attrs &attrs) override
	{
		...
		// setup texture
		{
			...
			// Todo: this cause FPE exception..
			auto image = images::NewtonFractal(
			        c_tex_side, c_tex_side, Vec3f(0.3, 0.1, 0.2), Vec3f(1.0, 0.8, 0.9),
...
static ObjectRegistry<SpuPage>::Creator<App> sandbox_creator("020_cube_mapping");
}  // namespace
}  // namespace spu::oglplus
