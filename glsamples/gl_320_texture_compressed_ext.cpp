...
public:
	...
	void init(const Attrs &attrs) override
	{
		...
		// texture
		{
			...
			const char *pathv[] = {
			        /*
			        "kueken7_rgb_dxt1_srgb.dds",
			        "kueken7_rgba_dxt5_srgb.dds",
			        */
			        "kueken7_rgb_dxt1_unorm.dds",
			        "kueken7_rgba_dxt5_unorm.dds",
			        "kueken7_r_ati1n_unorm.dds",
			        "kueken7_rg_ati2n_unorm.dds",

			};
			for (auto i = 0; i < 4; i++) {
				m_textureIds[i] = loadDDS(pathv[i], Attrs());
			}
		}
	}
...
static ObjectRegistry<SpuPage>::Creator<App> spu_sketch_creator("gl_320_texture_compressed_ext");
}  // namespace
}  // namespace spu
